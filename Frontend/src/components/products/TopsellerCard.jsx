...
const TopsallerProduct = () => {
  ...
  return (
    <div>
      <p className="text-center mt-[100px] text-[#303030] tracking-wide">
        Featured collection
      </p>

      <h1 className="text-center font-bold text-4xl p-4 text-[#303030] tracking-wide">
        TOP SELLERS
      </h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 p-4">
        {cardsitems.map((item, index) => (
          <div
            key={index}
            className="bg-white shadow-md rounded-xl overflow-hidden hover:shadow-lg transition duration-300 w-[300px] mx-auto"
